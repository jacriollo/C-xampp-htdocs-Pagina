...
<script>
  ...
  $('select#especialidad').on('change', function () {
    ...
    if(idEspecialidad >0)
       window.location.href = ruta+"/?controlador=citasP&accion=crearP&idEsp="+idEspecialidad+"&idMed=0&fec=";
  }); 
  $('select#medico').on('change', function () {
    ...
    if(idEspecialidad >0 && idMedico >0)
       window.location.href = ruta+"/?controlador=citasP&accion=crearP&idEsp="+idEspecialidad+"&idMed="+idMedico+"&fec="+fecha;    
  }); 
  $('#fecha').blur(function () {
    var idEspecialidad = $("#especialidad").val();      
    var idMedico = $("#medico").val();      
