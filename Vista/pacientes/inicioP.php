...
<table class="table table-bordered"> 
    ...
    <tr><td colspan="8"> <a href="?controlador=citasP&accion=crearP&idEsp=0&idMed=0&fec=" class="btn btn-success">Crear</a> </td></tr>
        <tr>
            <th>Fecha</th>
            <th>Hora</th>            
            <th>Paciente</th>
    ...
    <?php foreach($catalogos as $catalogo){?>
        <tr>            
            ...
            <div class="btn-group" role="group" aria-label="">                
                <a href="?controlador=citasP&accion=editar&id_cat=<?php echo $catalogo->id_cat; ?>" class="btn btn-info">Editar</a>
                <a href="?controlador=citasP&accion=borrar&id_cat=<?php echo $catalogo->id_cat; ?>" class="btn btn-danger">Borrar</a>                
            </div>    
           </td>
        </tr>           
        <?php }?>
