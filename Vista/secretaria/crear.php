...
<div  style="width:600px" class="card">
    ...
    <div class="mb-3">
      ...
      <input type="text"
      class="form-control" name="cedula" id="cedula" onkeyup="this.value=this.value.replace(/[^0-9]/, '');" style="width:400px" aria-describedby="helpId" placeholder="Cédula del usuario" Required>  
    ...
    <div class="mb-3">
      ...
      <input class="form-control" type="date" id="fecha" name="fecha" value="01-01-2020" min="1995-01-01" max="2020-01-01" style="width:400px" Required>
      <!--<input type="text" 
